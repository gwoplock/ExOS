...
OBJS += malloc.o New.o USB.o USBController.o PCI.o PCIDeviceList.o PCIDevice.o
OBJS += 
...
PCI.o: $(OS_CPP)/src/drivers/PCI/PCI.c
	$(GPP) $(CFLAGS) $(OS_CPP)/src/drivers/PCI/PCI.c
	
PCIDeviceList.o: $(OS_CPP)/src/drivers/PCI/PCIDeviceList.cpp
	$(GPP) $(CFLAGS) $(OS_CPP)/src/drivers/PCI/PCIDeviceList.cpp
...
>>>>>>> f5fb04e3c7c44b1baa96632f9854b72b1f197c4f
